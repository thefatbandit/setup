...
echo "OpenCV installation by TheFatBandit"
...
## Save current working directory (uncomment if you don't want to install in home) 
# cwd=$(pwd)
...
############ For Python 3 ############
Uncomment respective lines if you want opencv for python.
